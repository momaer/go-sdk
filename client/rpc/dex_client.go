...
type DexClient interface {
	...
	GetProposals(voteAddr, depositerAddr types.AccAddress, status types.ProposalStatus, numLatest int64) ([]types.Proposal, error)
...
func (c *HTTP) GetProposals(voteAddr, depositerAddr types.AccAddress, status types.ProposalStatus, numLatest int64) ([]types.Proposal, error) {
